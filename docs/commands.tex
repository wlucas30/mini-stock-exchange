...
the market-maker participants. The supplied price is recorded as their
acquisition cost. No orders are submitted automatically.
...
Displays the instrument's traded-price history alongside its exact hidden
fundamental-value history. The two series are shown as separately labelled
lines against simulation time.
