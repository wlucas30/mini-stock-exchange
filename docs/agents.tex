...
fixed number of ticks. It receives a small random shock on every simulation
step, but is pulled gradually back towards its normal level and remains within
