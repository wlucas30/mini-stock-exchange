...
When an instrument is first issued, its initial fundamental value is the issue
price supplied for its initial sell order. It begins in a neutral sentiment
regime. Its initial volatility is proportional to that price, subject to a
minimum of one tick. These defaults provide a complete hidden state without
requiring additional instrument-creation parameters.
